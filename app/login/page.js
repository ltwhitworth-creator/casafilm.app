        ...
        <div className="cf-right">
          <div style={{ width: '100%', maxWidth: '440px' }}>
            ...
            <p style={{ fontFamily: "'Albert Sans', sans-serif", fontSize: '15px', color: '#7a6e62', fontWeight: 400, marginBottom: '48px' }}>
              Continue to your Casa Film dashboard.
            </p>
            ...
            {message && (
              <p style={{ fontFamily: "'Albert Sans', sans-serif", fontSize: '13px', color: '#c0392b', lineHeight: 1.5, marginBottom: '24px' }}>
                {message}
              </p>
            )}

            <button className="cf-btn" onClick={handleLogin} disabled={loading}>
            ...
            <div style={{ marginTop: '52px', paddingTop: '32px', borderTop: '1px solid #ddd5c8', textAlign: 'center' }}>
              <p style={{ fontFamily: "'Albert Sans', sans-serif", fontSize: '14px', color: '#9a8e82', fontWeight: 400 }}>
                ...
                <a href="/signup" style={{ color: '#b5874a', textDecoration: 'none', fontWeight: 400 }}>
                  Create one free
                </a>
              </p>
            </div>
